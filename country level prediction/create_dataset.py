...
def convert_data(trainingdata_dir,
  ...
  samples_per_class = [498, 394, 7, 22, 206, 100, 47, 30, 18, 14, 5, 3]
  ...
  for filename in sorted(tf.gfile.ListDirectory(trainingdata_dir)):
    ...
    if offset!=0:  # Fast forward all files to skip the offset.
      training_num = [348, 275, 4, 15, 144, 70, 32, 21, 12, 9, 3, 2]
      if filename=="jordan_0.ndjson":
        offset = training_num[0]
      elif filename=="jordan_1.ndjson":
        offset = training_num[1]
      elif filename=="jordan_10.ndjson":
        offset = training_num[2]
      elif filename=="jordan_11.ndjson":
        offset = training_num[3]
      elif filename=="jordan_2.ndjson":
        offset = training_num[4]
      elif filename=="jordan_3.ndjson":
        offset = training_num[5]
      elif filename=="jordan_4.ndjson":
        offset = training_num[6]
      elif filename=="jordan_5.ndjson":
        offset = training_num[7]
      elif filename=="jordan_6.ndjson":
        offset = training_num[8]
      elif filename=="jordan_7.ndjson":
        offset = training_num[9]
      elif filename=="jordan_8.ndjson":
        offset = training_num[10]
      elif filename=="jordan_9.ndjson":
        offset = training_num[11]
